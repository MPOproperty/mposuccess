var TableNotifications = function () {
    ...
    var handleNotifications = function () {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "ajax": {
                    "url": "/panel/notifications", // ajax source
                },
                "order": [
                    [0, "asc"]
        ...
        grid.getTableWrapper().on('click', '.b-delete', function (e) {
            ...
            if (confirm('Вы действительно желаете удалить уведомление?')) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if(response) {
                            ...
                            $("#datatable_notifications").dataTable().fnDeleteRow( nRow );
                        } else {
