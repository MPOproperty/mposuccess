var TableManaged = function () {
    ...
    var initTableNews = function () {
        ...
        var tableWrapper = jQuery('#table_news_wrapper');
        ...
        table.on("click", '.b-delete', function (e) {
            ...
            if (confirm('Вы действительно желаете удалить новость?')) {
                ...
                $.ajax({
                    ...
                    type: "post",
                    url: "/panel/admin/news/delete/" + $(self).attr('data-id-news'),
                    cache: false,
        ...
        tableWrapper.find('div.row:first-of-type').prepend($('#table_news_filter').parent());
