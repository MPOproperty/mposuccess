var Login = function () {
	...
	var handleForgetPassword = function () {
		...
		$('.forget-form').validate({
	            ...
	            submitHandler: function (form) {
					/*$('#success-email').text('Вам отправлено письмо с ссылкой сброса пароля!');
	                form.submit();*/
					$.ajax({
						url: form.action,
						type: form.method,
						...
						success: function(data) {
							$('#success-email').text('Вам отправлено письмо с ссылкой сброса пароля!'); //Даем сообщение пользователю об успехе
							setTimeout(function() {
								$( "#backlogin" )[0].click(); //Переводим на страницу авторизации
							}, 1000);
						}
					});
					return false;
