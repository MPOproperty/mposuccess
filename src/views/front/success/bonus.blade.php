        ...
        <div class="portlet light">
            <div class="portlet-title tabbable-line">
                <div class="caption caption-md">
                    ...
                    <span class="caption-subject font-blue-madison bold uppercase">@lang('mposuccess::front.marketingOut.bonusProgram')</span>
                </div>
                <ul class="nav nav-tabs">
                    <li @if (!in_array(Session::get('tab'), [2])) class="active" @endif>
                        <a href="#tab_1_1" data-toggle="tab">@lang('mposuccess::front.marketingOut.startUp')</a>
                    </li>
                </ul>
            </div>
