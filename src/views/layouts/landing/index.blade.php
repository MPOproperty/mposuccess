    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-3 col-xs-12 item">
                ...
                <h3>СТАРТАП</h3>
                <p> Вступаем от 1600 рублей, <br><h4><strong> зарабатываем по 30т рублей</strong></h4></p>
            </div>
            <div class="col-md-3 col-sm-3 col-xs-12 item">
                <a target="_blank" href="http://www.vipaktiv.com/#!blank/fw28e">
...
<div class="portfolio-block content content-center" id="portfolio">
    ...
    <div class="row">
        ...
        <div class="item col-md-2 col-sm-6 col-xs-12">
            ...
            <a href="http://{{ config('mpouspehm.site_host') }}/news" class="zoom valign-center">
                <div class="valign-center-elem">
        ...
        <div class="item col-md-2 col-sm-6 col-xs-12">
            ...
            <a href="http://{{ config('mpouspehm.site_host') }}/success/structure" class="zoom valign-center">
                <div class="valign-center-elem">
        ...
        <div class="item col-md-2 col-sm-6 col-xs-12">
            ...
            <a href="http://{{ config('mpouspehm.site_host') }}/articles" class="zoom valign-center">
                <div class="valign-center-elem">
        ...
        <div class="item col-md-2 col-sm-6 col-xs-12">
            <img src="/images/onepages/portfolio/14.jpg" alt="NAME" class="img-responsive">
            <a href="http://{{ config('mpouspehm.site_host') }}/news/280" class="zoom valign-center">
                <div class="valign-center-elem">
                    <strong>ВЫГОДНЫЙ ТАРИФ </strong>
                    <em>(корпоративный) </em>
                    <b>Подробнее</b>
                </div>
            </a>
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6 pre-footer-col">
                ...
                <address class="margin-bottom-40">
                    ...
                    Email: <a href="mailto:info@mpouspehm.ru">info@mpouspehm.ru</a><br>
                    Skype: <a href="skype:mpouspehm">mpouspehm</a>
                </address>
            </div>
            <!-- END BOTTOM CONTACTS -->
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6 padding-top-10">
                2016 © МПО "Успех-М" <a href="javascript:;">Все права защещины</a> | <a href="javascript:;">Условия использования</a>
            </div>
            <!-- END COPYRIGHT -->
            <!-- BEGIN PAYMENTS -->
