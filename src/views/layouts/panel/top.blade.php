            ...
            <ul class="nav navbar-nav pull-right">
                ...
                <li class="dropdown dropdown-extended tooltip-wrap">
                    <a href="javascript:SwapDivsWithClick('header_balance_show','header_balance_hide')" class="dropdown-toggle">
                        <div id="header_balance_show" class="tooltips" data-placement="bottom" title="@lang('mposuccess::panel.balance_hide')" style="display: block">{{ $balance }} </div>
                        <div id="header_balance_hide" class="tooltips" data-placement="bottom" title="@lang('mposuccess::panel.balance_show')" style="display: none">************ </div>
                    </a>
                </li>
                @endif
                ...
                <li class="dropdown dropdown-user">
                    <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                        <img alt="" class="img-circle" src="{{ config('mposuccess.user_default_img') }}"/>
					<span class="username username-hide-on-mobile">{{Auth::user()->name}}</span>
                        <i class="fa fa-angle-down"></i>
                    </a>
                    <ul class="dropdown-menu dropdown-menu-default">
                        <li @if(Request::is(config('mposuccess.panel_url')  . "/personal")) class="active" @endif>
                            <a href="/{{ config('mposuccess.panel_url') }}/personal">
                                <i class="icon-user"></i> @lang('mposuccess::profile.topmenu.myprofile') </a>
                        </li>
                        <li @if(Request::is(config('mposuccess.panel_url')  . "/partner")) class="active" @endif>
                            <a href="/{{ config('mposuccess.panel_url') }}/partner/">
