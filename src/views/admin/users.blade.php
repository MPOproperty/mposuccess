<div class="portlet">
    <div class="portlet-title">
        <div class="caption">
            <i class="fa fa-shopping-cart"></i>@lang("mposuccess::panel.user.list")
        </div>
        <div class="actions">
        ...
        <div class="table-container">
            ...
            <table class="table table-striped table-bordered table-hover" id="datatable_users">
                ...
                <tr role="row" class="heading">
                    ...
                    <th width="5%">
                        @lang("mposuccess::panel.user.sid")
                    </th>
                    <th width="15%">
                        @lang("mposuccess::panel.user.fio")
                    </th>
                    <th width="10%">
                        @lang("mposuccess::panel.user.email")
                    </th>
                    <th width="10%">
                        @lang("mposuccess::panel.user.balance")
                    </th>
                    <th width="10%">
                        @lang("mposuccess::panel.user.role")
                    </th>
                    <th width="10%">
                ...
                <tr role="row" class="filter">
                    ...
                    <td>
                        <select name="role" class="form-control form-filter input-sm">
                            <option value="">@lang("mposuccess::panel.select")...</option>
