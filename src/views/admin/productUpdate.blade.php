    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <table class="table table-bordered table-striped">
                <tbody>
                <tr>
                    <td style='width:15%'> @lang('mpouspehm::panel.products.name') </td>
                    <td style="width:50%">
                        <a href="javascript:;" id="name" data-type="text" data-pk="1" data-placeholder="Вторая структура" data-original-title="@lang("mpouspehm::panel.enter") @lang("mpouspehm::panel.products.name")"> {{ !empty($product) ? $product->name : '' }} </a>
                    </td>
                </tr>
                <tr>
                    <td style='width:15%'> @lang('mpouspehm::panel.products.desc') </td>
                    <td>
                        <a href="javascript:;" id="desc" data-type="textarea" data-pk="1" data-placeholder="Описание.." data-original-title="@lang("mpouspehm::panel.enter") @lang("mpouspehm::panel.products.desc")"> {{ !empty($product) ? $product->des : '' }} </a>
                    </td>
                </tr>
                <tr>
                    <td style='width:15%'> @lang('mpouspehm::panel.products.url') </td>
                    <td style="width:50%">
                        <a href="javascript:;" id="url" data-type="text" data-pk="1" data-placeholder="one" data-original-title="@lang("mpouspehm::panel.enter") @lang("mpouspehm::panel.products.url")"> {{ !empty($product) ? $product->url : '' }} </a>
                    </td>
                </tr>
                <tr>
                    <td style='width:15%'> @lang('mpouspehm::panel.products.price') </td>
                    <td style="width:50%">
                        <input id="price_touchspin" type="text" value="{{ !empty($product) ? $product->price : 1 }}" name="price" class="form-control">
                    </td>
                </tr>
                <tr>
                    <td style='width:15%'> @lang('mpouspehm::panel.products.percent') </td>
                    <td style="width:50%">
                        <input id="percent_range" type="text" name="percent" value="0;100"/>
                    </td>
                </tr>
                <tr>
                    <td style='width:15%'> @lang('mpouspehm::panel.products.entities') </td>
                    <td style="width:50%">
                ...
                <tr>
                    <td style='width:15%'> @lang('mpouspehm::panel.products.count') @lang('mpouspehm::panel.products.countHelp')</td>
                    <td style="width:50%">
                        <input id="count_touchspin" type="text" name="count" value="{{!empty($product) ? $product->count : 0}}"/>
                    </td>
                </tr>
                <tr>
                    <td style='width:15%'> @lang('mpouspehm::panel.products.level') </td>
                    <td style="width:50%">
                        <a href="javascript:;" id="level" data-type="select" data-pk="1" data-value="{{ !empty($product) && $product->level > 0 ? $product->level : 1 }}" data-original-title="@lang("mpouspehm::panel.select") @lang("mpouspehm::panel.products.level")"></a>
                    </td>
                </tr>
