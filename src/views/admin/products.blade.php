    ...
    <div class="col-md-12">
        <div class="portlet-body">
            ...
            <table class="table table-striped table-bordered table-hover" id="table_products">
                ...
                <tr>
                    <th>
                        @lang('mpouspehm::panel.products.name')
                    </th>
                    <th>
                        @lang('mpouspehm::panel.products.desc')
                    </th>
                    <th>
                        @lang('mpouspehm::panel.products.url')
                    </th>
                    <th>
                        @lang('mpouspehm::panel.products.price')
                    </th>
                    <th>
                        @lang('mpouspehm::panel.products.percent')
                    </th>
                    <th>
                        @lang('mpouspehm::panel.products.cost')
                    </th>
                    <th>
                        @lang('mpouspehm::panel.products.count')
                    </th>
                    <th>
                        @lang('mpouspehm::panel.products.level')
                    </th>
                    <th>
                    </th>
                </tr>
