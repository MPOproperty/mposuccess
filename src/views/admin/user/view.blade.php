        ...
        <div class="portlet-body form">
            ...
            <form action="#" class="form-horizontal form-row-seperated">
                <div class="form-body">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-3">@lang('mposuccess::panel.user.created/updated')</label>
                        <div class="col-md-9">
