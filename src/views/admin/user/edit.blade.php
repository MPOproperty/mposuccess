...
<div class="modal-header">
    ...
    <h4 class="modal-title"> @lang('mposuccess::panel.user.edit')</h4>
    </div>
            ...
            <form action="#" class="form-horizontal form-row-seperated">
                <div class="form-body">
                    <div class="form-group">
                        <label class="control-label col-md-3">@lang('mposuccess::panel.user.surname')</label>
                        <div class="col-md-9">
                            <input name="surname" type="text" placeholder="@lang('mposuccess::panel.user.surname')" class="form-control" value="{{ $user->surname }}">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-3">@lang('mposuccess::panel.user.name')</label>
                        <div class="col-md-9">
                            <input name="name" type="text" placeholder="@lang('mposuccess::panel.user.name')" class="form-control" value="{{ $user->name }}">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-3">@lang('mposuccess::panel.user.patronymic')</label>
                        <div class="col-md-9">
                            <input name="patronymic" type="text" placeholder="@lang('mposuccess::panel.user.patronymic')" class="form-control" value="{{ $user->patronymic }}">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-3">@lang('mposuccess::panel.user.birthday')</label>
                        <div class="col-md-9">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-3">@lang('mposuccess::panel.user.email')</label>
                        <div class="col-md-9">
                            <input type="text" id="email" name="email" placeholder="name@gmail.com" class="form-control" value="{{ $user->email }}">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-3">@lang('mposuccess::panel.user.phone')</label>
                        <div class="col-md-9">
                            <input class="form-control" id="phone" name="phone" type="text" placeholder="(44) 123-45-67"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-3">@lang('mposuccess::panel.user.country')</label>
                        <div class="col-md-9">
                            <select name="country" id="select2_country" class="form-control select2 input-sm" data-placeholder="@lang('mposuccess::profile.regionNoSelect')">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-3">@lang('mposuccess::panel.user.program')</label>
                        <div class="col-md-9">
                    ...
                    <div class="form-group last">
                        <label class="control-label col-md-3">@lang('mposuccess::panel.user.role')</label>
                        <div class="col-md-9">
