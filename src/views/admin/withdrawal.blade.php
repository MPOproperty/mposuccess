<div class="portlet">
    <div class="portlet-title">
        <div class="caption">
            <i class="fa fa-shopping-cart"></i>@lang("mposuccess::panel.withdrawal.list")
        </div>
    </div>
        ...
        <div class="table-container">
            <table class="table table-striped table-bordered table-hover" id="datatable_withdrawal">
                ...
                <tr role="row" class="heading">
                    <th>
                        @lang('mposuccess::panel.withdrawal.id')
                    </th>
                    <th>
                        @lang('mposuccess::panel.withdrawal.status')
                    </th>
                    <th>
                        @lang('mposuccess::panel.withdrawal.method')
                    </th>
                    <th>
                        @lang('mposuccess::panel.withdrawal.user')
                    </th>
                    <th>
                        @lang('mposuccess::panel.withdrawal.price')
                    </th>
                    <th>
                        @lang('mposuccess::panel.withdrawal.date')
                    </th>
                    <th>
                    </th>
                </tr>
                <tr role="row" class="filter">
                    ...
                    <td width="20%">
                        <select name="status" class="form-control form-filter input-sm">
                            <option value="">@lang('mposuccess::panel.withdrawal.status')</option>
                    ...
                    <td width="20%">
                        <select name="method" class="form-control form-filter input-sm">
                            <option value="">@lang('mposuccess::panel.withdrawal.method')</option>
