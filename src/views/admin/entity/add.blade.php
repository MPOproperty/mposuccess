...
<div class="modal-header">
    ...
    <h4 class="modal-title"> @lang('mpouspehm::panel.entity.add')</h4>
    </div>
            ...
            <form id="form" action="#" class="form-horizontal form-row-seperated">
                <div class="form-body">
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input name="name" type="text" placeholder="@lang('mpouspehm::panel.entity.name')" class="form-control" value="">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-3">@lang('mpouspehm::panel.entity.description')</label>
                        <div class="col-md-9">
                            <input name="description" type="text" placeholder="@lang('mpouspehm::panel.entity.description')" class="form-control" value="">
                        </div>
                    </div>
