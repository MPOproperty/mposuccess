<div class="portlet">
    <div class="portlet-title">
        <div class="caption">
            <i class="fa fa-shopping-cart"></i>@lang("mposuccess::panel.transaction.list")
        </div>
        <div class="actions">
            <a href="/panel/admin/payments/create" class="btn default yellow-stripe">
                <i class="fa fa-plus"></i>
                <span class="hidden-480">
                    @lang('mposuccess::panel.add') </span>
            </a>
            <div class="btn-group">
        ...
        <div class="table-container">
            ...
            <table class="table table-striped table-bordered table-hover" id="datatable_payments">
                ...
                <tr role="row" class="heading">
                    ...
                    <th>
                        @lang('mposuccess::panel.transaction.status')
                    </th>
                    <th>
                        @lang('mposuccess::panel.transaction.type')
                    </th>
                    <th>
                        @lang('mposuccess::panel.transaction.user')
                    </th>
                    <th>
                        @lang('mposuccess::panel.transaction.price')
                    </th>
                    <th>
                        @lang('mposuccess::panel.transaction.from')
                    </th>
                    <th>
                        @lang('mposuccess::panel.transaction.to')
                    </th>
                    <th>
                ...
                <tr role="row" class="filter">
                    ...
                    <td width="10%">
                        <select name="status" class="form-control form-filter input-sm">
                            <option value="">@lang('mposuccess::panel.transaction.status')</option>
                    ...
                    <td>
                        <select name="type" class="form-control form-filter input-sm">
                            <option value="">@lang('mposuccess::panel.transaction.type')</option>
