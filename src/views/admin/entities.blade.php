        ...
        <div class="table-container">
            ...
            <table class="table table-striped table-bordered table-hover" id="datatable_entities">
                ...
                <tr role="row" class="heading">
                    ...
                    <th width="5%">
                        @lang("mpouspehm::panel.entity.image")
                    </th>
                    <th width="15%">
                        @lang("mpouspehm::panel.entity.name")
                    </th>
                    <th width="10%">
                        @lang("mpouspehm::panel.entity.description")
                    </th>
                    <th width="10%">
