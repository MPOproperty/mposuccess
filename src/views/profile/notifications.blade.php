<div class="portlet">
    <div class="portlet-title">
        <div class="caption">
            <i class="fa fa-shopping-cart"></i>@lang("mpouspehm::panel.notification.list")
        </div>
    </div>
        ...
        <div class="table-container">
            <table class="table table-striped table-bordered table-hover" id="datatable_notifications">
                ...
                <tr role="row" class="heading">
                    <th width="5%">
                        @lang("mpouspehm::panel.notification.name")
                    </th>
                    <th width="15%">
                        @lang("mpouspehm::panel.notification.text")
                    </th>
                    <th width="10%">
                        @lang("mpouspehm::panel.notification.date")
                    </th>
                    <th width="10%">
                        @lang("mpouspehm::panel.notification.status")
                    </th>
                    <th width="10%">
                ...
                <tr role="row" class="filter">
                    ...
                    <td>
                        <select name="status" class="form-control form-filter input-sm">
                            <option value="-1">@lang("mpouspehm::panel.select")...</option>
                            <option value="1">@lang("mpouspehm::panel.notification.status-read")</option>
                            <option value="0">@lang("mpouspehm::panel.notification.status-unread")</option>
                        </select>
                    </td>
                    <td align="center">
