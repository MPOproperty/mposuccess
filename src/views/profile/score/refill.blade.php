...
<div class="modal-header">
    ...
    <h4 class="modal-title">@lang('mpouspehm::profile.score.refill')</h4>
</div>
<div class="modal-body">
    <form method="post" action="{{ route(config('mpouspehm.panel_url') . '.payments.refillBalance') }}" enctype="multipart/form-data" id="refillBalanceId"
    data-validation="MPOproperty/Mpouspehm/Requests/RefillBalanceRequest">
        ...
        <div class="form-group">
         ...
         <div class="form-group">
            <label class="control-label">@lang('mpouspehm::payment.paymentForm.tax')</label>
        ...
        <div class="form-group">
            ...
            <button type="submit" class="btn green-haze">
                @lang('mpouspehm::payment.refillButton')
            </button>
        </div>
