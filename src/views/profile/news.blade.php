    ...
    <div class="col-md-12 blog-page">
        <div class="row">
            <div class="col-md-12 col-sm-10 article-block">
                @if (count($news))
                    <div class="row">
                        <div class="form-group">
                            <div class="col-md-10">
                                <h2 style="margin-top: 0">@lang('mposuccess::panel.news.latestNews')</h2>
                            </div>
                            <div class="col-md-2">
                                <form id="perPage">
                    ...
                    @for ($i = 0; $i < count($news); $i++)
                        ...
                        <div class="row">
                            <div class="col-md-4 blog-img blog-tag-data">
                                <img src="{{ $news[$i]->img ? config('mposuccess.news_storage_img') . $news[$i]->img : config('mposuccess.news_private_default_img') }}" alt="" class="img-responsive">
                            </div>
                ...
                @else
                    <h2 style="margin-top: 0">@lang('mposuccess::panel.news.none')</h2>
