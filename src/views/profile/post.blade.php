                    ...
                    <div class="col-md-3 blog-tag-data" style="float: right">
                        <ul class="list-inline" style="float: right; margin-top: 4px">
                            <li>
                                ...
                                <a href="javascript:;">
                                    {{ $news->updated_at or trans('mposuccess::panel.unknown') }} </a>
                            </li>
                        </ul>
                    </div>
                    <h3 style="margin: 0">
                        ...
                        @endif
                        {{ $news->name or trans('mposuccess::panel.unknown') }}</h3>
                </div>
                <div class="blog-tag-data">
                    @if($news->img)
                        <img src="{{ config('mposuccess.news_storage_img') . $news->img }}" class="img-responsive" alt="">
                    @endif
                </div>

                <div class="content" style="margin-bottom: 20px">
                    {!! $news->content or trans('mposuccess::panel.unknown') !!}
                </div>
