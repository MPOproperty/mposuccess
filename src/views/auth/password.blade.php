...
<div class="content">
	...
	<form class="forget-form" role="form" method="POST" action="/password/email">
	<input type="hidden" name="_token" value="{{ csrf_token() }}"> 
		<h3>Забыли пароль ?</h3>
		<p>
			Введите ваш адрес электронной почты, который был указан при регистрации.
		</p>
		<p id="success-email" style="color:red;"></p>
		<div class="form-group">
			<div class="input-icon">
				<i class="fa fa-envelope"></i>
				<input class="form-control placeholder-no-fix" type="text" autocomplete="off" name="email" value="{{ old('email') }}" />
			</div>
		</div>
		<div class="form-actions">
			<a class="btn" id="backlogin" href="/auth/login" style="background:#fff;border:1px solid #cccccc;">
				<i class="m-icon-swapleft"></i> Назад </a>
