...
return array(
	 ...
	 * @type string
	 */
	'model_config_path' => __DIR__. '/administrator',
	 ...
	 * @type string
	 */
	'settings_config_path' => __DIR__. '/administrator/settings',
	...
	'permission'=> function()
	{
		return Auth::check() &&  \MPOproperty\Mposuccess\Models\User::find(Auth::user()->id)->isAdmin();
	},
