...
return [
    ...
    */
    'custom' => [
        'surname' => [
            ...
            'min'      => 'В фамилии должно быть минимум 2 символа',
            'cyrillic' => 'Фамилия должно содержать только кириллицу.',
        ],
        'name' => [
            'required' => 'Введите ваше имя',
            'min'      => 'В имени должно быть минимум 2 символа',
            'cyrillic' => 'Имя должно содержать только кириллицу.',
        ],
        'patronymic' => [
            'required' => 'Введите ваше отчество',
            'min'      => 'В отчестве должно быть минимум 2 символа',
            'cyrillic' => 'Отчество должно содержать только кириллицу.',
        ],
        'birthday' => [
    ...
    */
    'attributes' => [
        ...
        'price'  => '"Цена"',
        'price_intake'  => '"Цена"',
        'price_deduction'  => '"Цена"',
        'price_transfer'  => '"Цена"',
        'user_to' => '"Пользователь"',
        'user_from' => '"Пользователь"',
        'user_transfer_from' => '"Пользователь"',
        'user_transfer_to' => '"Пользователь"',
        'price_refill' => '"Цена"',
        'description_refill' => '"Описание"',
        'price_conclusion' => '"Цена"',
        'description_conclusion' => '"Описание"',
        'method_conclusion' => '"Способ"',
        'date_conclusion' => '"Дата"',
    ],
];
