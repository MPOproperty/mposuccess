...
class User extends Model implements AuthenticatableContract, CanResetPasswordContract, HasRoleAndPermissionContract
{
    ...
    public function notifications(){
        return $this->hasMany('MPOproperty\Mpouspehm\Models\Notification', 'sid');
    }
    ...
    {
        return $this->hasOne('MPOproperty\Mpouspehm\Models\Payment', 'id');
    }
    ...
    {
        return $this->hasOne('MPOproperty\Mpouspehm\Models\Program', 'id', 'program');
    }
    ...
    {
        return $this->hasOne('MPOproperty\Mpouspehm\Models\Country', 'code', 'country');
    }
    ...
    {
        return $this->hasOne('MPOproperty\Mpouspehm\Models\RoleUser', 'user_id', 'id');
    }
}
