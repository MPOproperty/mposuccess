...
class Product extends Model
{
    ...
    {
        return $this->hasMany('MPOproperty\Mpouspehm\Models\ProductEntities', 'product_id');
    }

    public function entities_all()
    {
        return $this->belongsToMany('MPOproperty\Mpouspehm\Models\Entity', 'product_entities', 'product_id', 'entity_id')->withPivot('count');
    }
}