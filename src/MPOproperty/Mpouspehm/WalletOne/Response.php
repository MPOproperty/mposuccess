...
use MPOproperty\Mpouspehm\WalletOne;
                ...
                if (strtoupper($_POST["WMI_ORDER_STATE"]) == "ACCEPTED") {
                    ...
                    if ($resultTransaction) {
                        ...
                        $this->payment->setPaymentNotification(
                            $resultTransaction->user_id,
                            trans('mpouspehm::payment.notificationNames.INTAKE_INTERNAL'),
                            trans('mpouspehm::payment.notificationMessages.INTAKE_INTERNAL',
