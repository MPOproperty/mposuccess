<?php namespace MPOproperty\Mposuccess\BinaryTree;

use MPOproperty\Mposuccess\Contracts\BinaryTree\SheetInterface;
...
class Sheet implements SheetInterface {
    ...
    public function getDataMembers()
    {
        ...
        $userRepository = app('MPOproperty\Mposuccess\Repositories\User\UserRepository');
