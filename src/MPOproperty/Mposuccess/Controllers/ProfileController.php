...
class ProfileController extends UserController {
    ...
    {
        $this->layout->content = view("mposuccess::profile.bonus");
        $this->layout->title = trans('mposuccess::profile.bonus');
        return $this->layout;
    }
    /**
     * Помощник
    ...
    {
        $this->layout->content = view("mposuccess::profile.helper");
        $this->layout->title = trans('mposuccess::profile.helper');
        return $this->layout;
    }
    ...
    public function structures(TreeUserSettings $settings, $id, $sid = null)
    {
        ...
        TreeRepository::setTable('MPOproperty\Mposuccess\Models\Tree' . $id);
        $tree = app('MPOproperty\Mposuccess\Repositories\Tree\TreeRepository');
        ...
        if(! is_null($currentPlace) && is_null($sid)) {
            return \Redirect::to(route(config('mposuccess.panel_url') . '.structures', [
                'id' => $id,
                'sid' => $currentPlace
            ]));
        }
    ...
    public function build(Request $request, $level, $sid, $currentSid){
        ...
        TreeRepository::setTable('MPOproperty\Mposuccess\Models\Tree' . $level);
        $tree = app('MPOproperty\Mposuccess\Repositories\Tree\TreeRepository');
    ...
    public function notifications(Request $request, NotificationRepository $notificationRepository)
    {
        if ($request->isMethod('get')) {
            ...
            $this->layout->content = view("mposuccess::profile.notifications");
            $this->layout->title = trans('mposuccess::panel.notification.title');
            return $this->layout;
    ...
    public function notification(Request $request, $count){
        ...
        $notifications = app('MPOproperty\Mposuccess\Repositories\Notification\NotificationRepository');
