...
use MPOproperty\Mposuccess\Models\Withdrawal;
...
class WithdrawalRepository extends Repository
{
    ...
    function model()
    {
        return 'MPOproperty\Mposuccess\Models\Withdrawal';
    }
    ...
    public function findByParamsForTable($params){
        ...
        $linkEndPaid = '/paid" class="btn default btn-xs purple b-edit" data-target="#ajax" data-toggle="modal"><i class="fa fa-edit"></i>' .  trans('mposuccess::panel.statusPaid') . '</a>';
        $linkEndRejected = '/rejected" class="btn default btn-xs purple b-edit" data-target="#ajax" data-toggle="modal"><i class="fa fa-edit"></i>' .  trans('mposuccess::panel.statusRejected') . '</a>';
