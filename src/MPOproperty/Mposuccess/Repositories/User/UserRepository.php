<?php namespace MPOproperty\Mposuccess\Repositories\User;
/**
 * Created by PhpStorm.
 * User: Andersen_user
 * Date: 22.08.2015
...
class UserRepository extends Repository {
    ...
    function model()
    {
        ...
        return 'MPOproperty\Mposuccess\Models\User';
    }
    ...
    public function findByParamsForTable($params){
        ...
        foreach($result['users'] as $user) {
            ...
            $records["data"][] = array(
                ...
                '<a href="/panel/admin/user/' . $user->id .'/view" class="btn default btn-xs blue-stripe b-load" data-target="#ajax" data-toggle="modal">' . trans('mposuccess::panel.view') . '</a>' .
                '<a href="/panel/admin/user/' . $user->id .'/edit" class="btn default btn-xs purple b-load" data-target="#ajax" data-toggle="modal"><i class="fa fa-edit"></i>' .  trans('mposuccess::panel.edit') . '</a>' .
                '<a data-href="/panel/admin/user/' . $user->id .'/delete" class="btn default btn-xs black b-delete" data-id-news="{{$item->id}}"><i class="fa fa-trash-o"></i>' . trans('mposuccess::panel.delete') . '</a>',
