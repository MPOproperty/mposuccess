<?php namespace MPOproperty\Mposuccess\Repositories\Menu;
/**
 * Created by PhpStorm.
 * User: Andersen_user
 * Date: 22.08.2015
...
use MPOproperty\Mposuccess\Repositories\Menu\Contract\MenuEloquent;
...
class MenuRepository extends MenuEloquent {
    ...
    function model()
    {
        return 'MPOproperty\Mposuccess\Models\Menu';
    }
    private $item = null;
